...
// interface의 모든 필드는 public static final이다
// interface의 모든 메서드는 public abstract이다
...
interface Test3{
	...
	// static이므로 어던 객체에서 접근해도 동일한 값이다
	// final이므로 하번 지정된 값은 변경할 수 없으며, 반드시 초기값을 지정해야만 한다
...
//		Test3 ob = new Test3(); // 인터페이스는 추상 클래스이므로, 생성자를 통한 객체 직접 생성이 불가능하다.
		...
		// 인터페이스는 추상클래이므로, 익명 내부 클래스를 활용하여 객체를 생성할 수 있다
		Test3 ob2 = new Test3() {
