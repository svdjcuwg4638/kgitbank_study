...
abstract class Test1 {
	Test1(){
		System.out.println("Test1생성자 호출!!");
	}
...
class Test2 extends Test1{
	...
	@Override	// 형식은 그대로 유지하면서, 내용은 그대로 작성하여 덮어쓴다
...
public class Ex01 {
	...
	// 추상메서드 : 형식은 정의되어 있으나, 내용은 정의되지 않은 메서드
	// 추상 클래스 : 추상 메서드를 포함할 수 잇는 클래스(일반 매서드도 포함 가능하다)
	
	public static void main(String[] args) {
//		Test1 ob = new Test1();	// 추상 클래스의 생성자는 직접 호출할 수 없다(객체화가 불가능하다)
		Test2 ob2 = new Test2();
		ob2.function1();
		ob2.function2();
	}
