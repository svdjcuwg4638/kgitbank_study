...
interface USB{	// 인터페이스는 추상 클래스,추상클래스는 클래스, 클래스는 자료형
	void action();
}
...
class portableSSD extends Object implements USB{	// 데이터 입출력
	@Override
	public void action() {
...
class PC{
	// 컴퓨터 외부 장치를 연결하기 위해서는 USB 인터페이스 규격을 만족하면 된다
	// => 자료형이 USB이면 가능하다(다형성)
...
public class Ex04 {
	public static void main(String[] args) {
		...
		// 3) 함수의 반환형이 void가 아니고, 한줄에만 값을 반환한다면 return 생략 가능
